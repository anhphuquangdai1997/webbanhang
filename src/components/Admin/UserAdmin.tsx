...
const UsersList = () => {
  ...
  const deleteUserHandler = (id: string) => {
    alert(`Bạn đã xóa user với ID: ${id}`);
    // Nếu muốn gọi API xoá thật, có thể thêm axios.delete ở đây rồi fetch lại danh sách
  };
              ...
              <tbody className="divide-y divide-gray-200">
                {users.map((user) => (
                  <tr key={user._id} className="hover:bg-gray-50 transition">
                    ...
                    <div className="px-3 py-2 whitespace-nowrap text-sm text-gray-700">
                      <img
